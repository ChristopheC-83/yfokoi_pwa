...
export default function SharedInput({ user }) {
  const [newItem, setNewItem] = useState("");
  const inputRef = useRef(null);
  const addItem = useSharedItemsStore((state) => state.addItem);
  ...
  return (
    <form
     ...
     text-gray-900 text-sm rounded-lg flex justify-between sticky top-2 my-2"
